...
export default class Light {
  ...
  init() {
    ...
    this.directionalLight.position.multiplyScalar(Config.directionalLight.multiplyScalar);
    this.directionalLight.visible = Config.directionalLight.enabled;
    this.directionalLight.color.setHSL(Config.directionalLight.hue, Config.directionalLight.saturation, Config.directionalLight.lightness);
